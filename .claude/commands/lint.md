...
Read `knowledge-base/wiki/index.md` to get a full picture of all pages. Then read through the wiki pages systematically — sources, entities, concepts, and analyses.
...
- **Index drift:** Pages that exist but aren't listed in `knowledge-base/wiki/index.md`, or index entries for pages that no longer exist
...
Update `knowledge-base/wiki/index.md` if any pages were created, removed, or significantly changed.
