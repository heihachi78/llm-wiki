...
Read `wiki/index.md` to find pages relevant to the question in `$ARGUMENTS`. Read the most relevant wiki pages to understand what the wiki already knows about this topic.
